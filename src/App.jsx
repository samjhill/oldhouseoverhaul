  ...
  return (
    <div className="app">
      ...
      <section className="about">
          <h2>Who are we?</h2>
          <p>
            We're a group of people who seek adventure. Expect physical challenges, adrenaline, and the unexpected. A great mixture of <a href="https://www.rei.com/blog/climb/fun-scale" target="_blank">type 1 and type 2 fun</a>.
          </p>
        </section>
        <section className="about">
          <h2>Why join us?</h2>
